relations = [
    ...
    },
    {
        ...
        data: [
            ...
            [5, "2000-02-02", "...and originality have made Einstein s...", 2, 2],
            [6, "2000-02-12", "...that if the special theory is correc...", 3, 3],
            [7, "2000-01-01", "...For much of the last phase of his ac...", 1, 1],
            [8, "1999-03-01", "...he enrolled in the mathematics and p...", 2, 2],
            [9, "2001-05-22", "...Horrified by the Nazi war of extermi...", 3, 3],
            [10, "2006-01-02", "...Einstein supported the Allies but ge...", 1, 2]
        ]
    }
]
